...
echo "tux 1.0" > $RPM_BUILD_ROOT/etc/system-release
echo "cpe://o:tux:tux:1.0" > $RPM_BUILD_ROOT/etc/system-release-cpe
cp -p $RPM_BUILD_ROOT/etc/system-release $RPM_BUILD_ROOT/etc/issue
echo "TUX" >> $RPM_BUILD_ROOT/etc/issue
...
%defattr(-,root,root,-)
%doc GPL 
%config %attr(0644,root,root) /etc/redhat-release
/etc/system-release
...
%changelog
* Mon Feb 22 2010 Tom "spot" Callaway <tcallawa@redhat.com> - 13-0.6
- sync again, fix broken deps, broken testing repo

* Wed Feb 17 2010 Tom "spot" Callaway <tcallawa@redhat.com> - 13-0.4
